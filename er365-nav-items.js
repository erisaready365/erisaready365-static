/* ============================================================
   ...
   Version: 3.2 (2026-09-12)
   ------------------------------------------------------------
   CHANGES v3.2:
     - Added Investment Management to Compliance, directly
       below Governance Calendar.
         id:  investment-management
         url: BASE + 'investment-management'
       Compliance now carries 8 children; the plan nav totals
       42 children across 10 parents.
     - Corrected a stale comment: the file said "44 children"
       and the real count was 41 before this change. Counted,
       not assumed.
     - No other change. Nothing was reordered, renamed or removed.
   CHANGES v3.1:
...
(function () {
  ...
  // Plan-context nav — 10 parents, 42 children  (counted 2026-09-12)
  var NAV_ITEMS = [
    ...
    { id: 'compliance', label: 'Compliance', context: 'plan', order: 8, children: [
      ...
      { id: 'investment-management',         label: 'Investment Management',            url: BASE + 'investment-management' },
